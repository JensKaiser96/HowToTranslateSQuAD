...
https://rajpurkar.github.io/SQuAD-explorer/ -> "Evaluation Script"
"""
import argparse
import collections
import json
...
def compute_f1_precision_recall(a_gold, a_pred) -> tuple[float, float, float]:
...
def compute_f1(a_gold, a_pred):
    f1, _, _ = compute_f1_precision_recall(a_gold, a_pred)
    return f1
